...
def save_reconstruction_ply(savedir, filename, keyframes: SharedKeyframes, c_conf_threshold, voxel_size=0.01, keyframe_indices=None, min_depth=0.1, max_depth=3.8):
    ...
    Args:
        ...
        max_depth: Maximum depth in meters (default: 3.8m). Points farther than this are filtered out.
    """
